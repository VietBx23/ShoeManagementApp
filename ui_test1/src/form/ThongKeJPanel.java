...
/////////////////////// 4 BẢNG VUÔNG /////////////////////////////////
    ...
    public void fillTableBang() {
        ...
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/icon/customer (1).png")), "Tổng hóa đơn/ngày", tongHoaDon1Ngay, "Increased by 60%"));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/icon/letter-d.png")), "TB doanh thu/ngày", doanhThuTBNgay, "Increased by 25%"));
        card3.setData(new Model_Card(new ImageIcon(getClass().getResource("/icon/letter-m.png")), "TB doanh thu/tháng", doanhThuTBThang, "Increased by 70%"));
        card4.setData(new Model_Card(new ImageIcon(getClass().getResource("/icon/letter-y.png")), "Tổng doanh thu/năm", doanhThuNam, "Increased by 50%"));
...
/////////////////////// SẢN PHẨM /////////////////////////////////
    ...
    private void fillTableSanPhamTheoNgay() {
        ...
        List<Object[]> list = dao.getSanPhamTheoNgay(tuNgay, denNgay);
        for (Object[] row : list) {
            model.addRow(row);
        }
